...
const makeStyles = (t) =>
  StyleSheet.create({
    ...
    streakNumber: { fontSize: 22, fontWeight: '800', color: t.text },
    streakStat: { fontSize: 16, fontWeight: '800', color: t.text },
    streakProgressTrack: {
      marginTop: 6,
      height: 10,
      borderRadius: 999,
    ...
    tipTitle: { color: '#f43f5e', fontWeight: '800', fontSize: 13, letterSpacing: 0.4 },
    tipText: { marginTop: 8, fontSize: 14, color: t.text, fontStyle: 'italic' },
    tipAuthor: { marginTop: 6, fontSize: 12, color: t.sub, textAlign: 'right' },
  })
