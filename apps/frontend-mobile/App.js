      ...
      {!loggedIn ? (
        ...
        <View style={{ flex: 1 }}>
          <ScrollView contentContainerStyle={{ paddingBottom: 120 }}>
            {activeTab === 'profile' ? (
              <ProfileView portal={portal} styles={styles} theme={theme} />
            ) : (
              <HomeView
                portal={portal}
                styles={styles}
...
function ProfileView({ portal, styles, theme }) {
      ...
      <View style={styles.profileCard}>
        ...
        <View style={styles.infoRow}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.infoValue}>{student.email || 'Sin correo'}</Text>
          </View>
        </View>
        <View style={styles.infoRow}>
          <View style={styles.infoIconWrap}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.infoValue}>{student.phone || 'Sin telefono'}</Text>
          </View>
        </View>
        <View style={styles.infoRow}>
          <View style={styles.infoIconWrap}>
        ...
        <View style={styles.infoRow}>
          <View style={styles.infoIconWrap}>
            <Ionicons name="calendar-number-outline" size={18} color="#ec4899" />
          </View>
          <View style={{ flex: 1 }}>
            <Text style={styles.infoLabel}>Fecha de inscripcion</Text>
