                                               ...
                                               <td className="block md:table-cell pr-8 md:pr-12 pl-8 py-4 md:py-6 text-right">
                                                  <div className="flex items-center justify-start md:justify-end gap-3">
                                                     {(() => {
                                                        ...
                                                        const msg = `¡Hola ${s.first_name}! ${String.fromCodePoint(0x1F44B)} ${customPart} Esperamos que estés disfrutando mucho tus clases. Te recordamos que tienes un pago pendiente para el curso ${row.course.name}. ¡Nos vemos pronto! ${String.fromCodePoint(0x2728)}`
